    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Si")
        {
            SqlConnection cn = new SqlConnection("Data Source=200.77.121.114;Initial Catalog=GRULOP;User ID=useradmin;Password=admin123*");
            {
                ...
                cn.Open();
                SqlCommand consulta = new SqlCommand("update T_Articuladounidades set cve_bajal = '0', fe_articulado = getdate() where contador_folio = '" + Label8.Text + "'", cn);
            ...
            SqlConnection cn1 = new SqlConnection("Data Source=200.77.121.114;Initial Catalog=GRULOP;User ID=useradmin;Password=admin123*");
            {
                ...
                SqlCommand tracto = new SqlCommand("update T_Parqvehicular set articulado = '0' where no_econ = '" + Label10.Text + "'", cn1);
                SqlCommand remolque1 = new SqlCommand("update T_Parqvehicular set articulado = '0' where no_econ = '" + Label11.Text + "'", cn1);
                SqlCommand dolly = new SqlCommand("update T_Parqvehicular set articulado = '0' where no_econ = '" + Label12.Text + "'", cn1);
                SqlCommand remolque2 = new SqlCommand("update T_Parqvehicular set articulado = '0' where no_econ = '" + Label13.Text + "'", cn1);
