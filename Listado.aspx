<%@ Page Title="TRETSA - Listado" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Listado.aspx.cs" Inherits="Listado" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" AllowPaging="true" ShowHeaderWhenEmpty="True" EmptyDataText = "No se han creado articulados!" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False">
     ...
     DataNavigateUrlFormatString="~/Buscar.aspx?id={0}" 
		Text="Detalle" />
