<%@ Page Title="TRETSA - Detalle" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Detalle.aspx.cs" Inherits="Detalle" %>
    ...
    <div>
        ...
        <asp:Table runat="server">
            <asp:TableHeaderRow>
                ...
                <asp:TableCell>
                            <asp:Label ID="Label19" runat="server" Text="Fecha y Hora de Desarticulado" Width="200px"></asp:Label>
                </asp:TableCell>
            </asp:TableHeaderRow>
            <asp:TableHeaderRow>
                <asp:TableCell>
                ...
                <asp:TableCell>
                            <asp:Label ID="Label20" runat="server" Text="Label" Font-Bold="True" Font-Size="Small" ForeColor="Maroon"></asp:Label>
                </asp:TableCell>
            </asp:TableHeaderRow>
        </asp:Table>
        <br />
<asp:Label ID="Label5" runat="server" Text="Tipo de Articulado"></asp:Label>
        ...
        <asp:Table runat="server">
            <asp:TableHeaderRow>
                ...
                <asp:TableCell>
                    <asp:Label ID="Label21" runat="server" Text="Label" Font-Bold="True" Font-Size="Medium" Width="180px"></asp:Label>
                </asp:TableCell>
            </asp:TableHeaderRow>
        </asp:Table>
        <br />
